...
final List<Email> emails = [
  ...
  Email(
    ...
    subject: 'Dinner Club',
    content:
        'I think it s time for us to finally try that new noodle shop downtown that doesnt use menus. Anyone else have other suggestions for dinner club this week? Im so intrigued by this idea of a noodle restaurant where no one gets to order for themselves - could be fun, or terrible, or both :)\n\nSo',
  ),
  Email(
    sender: user_3,
    recipients: [],
